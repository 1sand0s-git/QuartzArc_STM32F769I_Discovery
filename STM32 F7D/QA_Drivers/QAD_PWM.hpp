...
//alternatively check the reference documentation for the STM32F769I device.
...
private:
  ...
  uint32_t           m_uChannelSelect[QAD_PWM_CHANNEL_COUNT];     //Array used to select TIM_Channel defines as defined in stm32f7xx_hal_tim.h
