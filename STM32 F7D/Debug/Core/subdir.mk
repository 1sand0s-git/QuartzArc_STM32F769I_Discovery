...
clean-Core:
	-$(RM) ./Core/boot.d ./Core/boot.o ./Core/handlers.d ./Core/handlers.o ./Core/main.d ./Core/main.o ./Core/syscalls.d ./Core/syscalls.o ./Core/sysmem.d ./Core/sysmem.o ./Core/system_stm32f7xx.d ./Core/system_stm32f7xx.o
